...
DEFAULT_SCHEMA: list[dict] = [
    ...
    {
        "name": "services",
        "label": "Additional forms / services needed",
        "type": "checkboxes",
        # Values match fee_schedule.json keys so invoices price automatically.
        "options": [
            {"label": "State return", "value": "state_return"},
            {"label": "Itemized deductions (Schedule A)", "value": "schedule_a"},
            {"label": "Self-employment (Schedule C)", "value": "schedule_c"},
            {"label": "Capital gains (Schedule D)", "value": "schedule_d"},
            {"label": "Rental income (Schedule E)", "value": "schedule_e"},
            {"label": "Education credits (Form 8863)", "value": "education_8863"},
            {"label": "Child & dependent care (Form 2441)", "value": "childcare_2441"},
            {"label": "HSA (Form 8889)", "value": "hsa_8889"},
            {"label": "Amended return (1040-X)", "value": "amended_1040x"},
        ],
    },
