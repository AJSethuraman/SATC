"""Seventh walk (a5a8aa2). Build the one-file procedure: Markdown -> HTML with every picture embedded -> PDF.
...
<text x="490" y="66" text-anchor="middle">Start here → Control (9 calls; 4 offer a suggestion)</text><text x="490" y="86" text-anchor="middle">→ Columns (C3 = Yes) → Odd values (real / missing)</text>
...
<text x="755" y="236" text-anchor="middle">Where it bleeds (blue: too small to test) → Losses vs revenue → Grids</text><text x="755" y="256" text-anchor="middle">→ Materiality → Check → Log; Control: Last Run used</text><text x="755" y="280" text-anchor="middle" font-size="11">planted pocket: FICO under 654 / Broker, first; "Losing more, earning the same"</text>
...
<text x="230" y="236" text-anchor="middle">Split (method block, luck in brackets) + Three-way</text><text x="230" y="256" text-anchor="middle">Show per pocket · edges or every 20 · a high floor · Set up again</text><text x="230" y="276" text-anchor="middle">Forget · the next extracts · remembered band edges</text>
