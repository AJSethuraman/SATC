...
muts = [
 ...
 ("dollars against the book", B, '    return (band, whole) if peers else (whole, band)',
  '    return (whole, band)', "dollars_agree or engines_and_the_other"),
 ...
 ("ranked by the book's dollars", B, '                if s.dollars is not None and s.dollars > 0:\n                    found.append((s.dollars, g, bl, dl, s))',
  ...
  "one_comparison"),
 ("the reference dollars hidden", B, '    return (band, whole) if peers else (whole, band)',
  '    return (band, None) if peers else (whole, None)', "one_comparison"),
