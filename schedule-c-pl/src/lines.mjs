...
export function buildLines(otherExpensesLine) {
  ...
  const lines = [
    ...
    L('11', 'II', 'entry', 'Contract labor', 'Contract labor and subcontractors'),
    ...
    L('23', 'II', 'entry', 'Taxes and licenses', 'Taxes and licenses'),
    ...
    L('37', 'III', 'entry', 'Cost of labor. Do not include any amounts paid to yourself', 'Cost of labor'),
