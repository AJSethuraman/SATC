...
| Claim in the draft | Source |
|---|---|
| Older holdings arrive with the cost box empty, because reporting started after a cut-off that differs by kind of security | Same page — [Instructions for Form 1099-B](https://www.irs.gov/instructions/i1099b) sets the cut-off as custody transferred "after 2010 (after 2011 if the stock is in a regulated investment company and after 2014 for certain debt instruments, options, and securities futures contracts)". Anything held from before its own cut-off is noncovered, and the basis box comes through empty |
