...
|---|---|
| W-2s are due to the employee by January 31 | **THE FIRM SETTLED HOW DATES ARE WRITTEN (C001).** Their instruction: *be general: use January 31 and the other standard dates, then say you have to account for weekends and holidays as well* So the guide keeps the statutory date and states the rule that moves it, which is what it already did. This row reports PARTIAL forever, and that is correct rather than broken: the claim says January 31, the current instructions say February 1, 2027, and the gap between those two **is** the rule. **CITATION REPLACED, AND IT PROVED THE WEEKEND RULE** — the row used to cite a 2023 newsroom tax tip, which says only "The due date to file 2022 Form W-2, Form W-3, and Form 1099-NEC is January 31, 2023". That is the date the employer files with the SSA, not the date the employee gets the form, and the claim is about the employee. The right page is the [General Instructions for Forms W-2 and W-3](https://www.irs.gov/instructions/iw2w3), which says "you must furnish Copies B, C, and 2 of Form W-2 to your employees by February 1, 2027" — February 1, because 31 January 2027 is a Sunday. So the statutory date is January 31 and the current edition of the instructions already shows it moved. This is the rule the guide states rather than a fixed date, and here is the rule visibly operating in the source |
...
| Form 1095-A comes from the marketplace, early in the year | [Health Insurance Marketplace statements](https://www.irs.gov/affordable-care-act/individuals-and-families/health-insurance-marketplace-statements) — "Early in the year, you may receive one or more forms providing information about the health care coverage that you had or were offered during the previous year." **CHECKED, AND THE DRAFT WAS CHANGED**: the draft said the form was due to you by January 31. The string "January 31" does not appear on that page. A January 31 furnishing date may well be right, but it is set elsewhere and this citation does not carry it |
...
| Exchanges start reporting the purchase price for 2026 sales | [Instructions for Form 1099-DA](https://www.irs.gov/instructions/i1099da) — "2026 and beyond - Mandatory reporting of gross proceeds for all digital assets, mandatory reporting of basis information for digital assets that are covered securities, and voluntary reporting of basis information for digital assets that are noncovered securities". The same page defines the cut-off: "a covered security is a digital asset acquired after 2025"  |
...
| Claim in the draft | Source |
|---|---|
| Ohio adds a state return, usually a city return, and sometimes a school district one | [Ohio Department of Taxation — Income: School District Tax](https://tax.ohio.gov/help-center/faqs/income-school-district) — "A school district income tax is in addition to any federal, state, and city income or property taxes", and it exists only where voters enacted it: "Ohio school districts may enact a school district income tax with voter approval." That is precisely the guide's "sometimes"  |
...
| The local boxes on a W-2 are what a city return runs on | [RITA Form 37 (2025)](https://www.ritaohio.com/Media/703125/2025%20FORM%2037.pdf) — Section A asks the filer to "List all income from W-2 wages and W-2G winnings reported in 2025 and the amount of local/city tax withheld while living in a RITA municipality." **This is the current form**, unlike the 2010-vintage instructions PDF the row above used to cite |
...
| Mileage: written, kept as you drive, with date, distance and reason | [Publication 463](https://www.irs.gov/publications/p463) — "You should record the elements of an expense or of a business use at or near the time of the expense or use and support it with sufficient documentary evidence", and "A timely kept record has more value than a statement prepared later when there is generally a lack of accurate recall." That second sentence is the whole reason the guide says a total worked out in April is a different thing |
...
| A receipt does not carry who was there or why | [Publication 463](https://www.irs.gov/publications/p463) — the elements that have to be recorded include "the place, business purpose, or business relationship", and where they are left off a receipt the page requires that "you do have to record the information elsewhere at or near the time of the expense and have it available to fully prove that element of the expense"  |
| $2,000 or more to a non-employee usually means a 1099-NEC, due to them and to the IRS by January 31 | **THE FIGURE IN THE GUIDE WAS $600 AND IT IS WRONG FOR THIS TAX YEAR.** The [Instructions for Forms 1099-MISC and 1099-NEC (12/2026)](https://www.irs.gov/instructions/i1099mec) say to file "for each person in the course of your business during the year to whom you have paid at least $2,000 in: Services performed by someone who is not your employee". The What's New section gives the reason: "For tax years beginning after 2025, the minimum threshold amount for reporting certain payments required to be reported on certain information returns and/or perform backup withholding on those payments increased to $2,000 and may be adjusted for inflation beginning in calendar year 2027." The change is P.L. 119-21. Today is in tax year 2026, so $2,000 is the live number and $600 would have had a business owner issuing forms it no longer owes — or, worse, trusting us on a figure anyone could check. **This is the find that justifies the whole pass.** The guide now gives $2,000, says it used to be $600, and says it indexes |
...
| A partnership or corporate return is due March 15 for a calendar year, with owner K-1s due on that date | [Instructions for Form 1065](https://www.irs.gov/instructions/i1065) — the return is due "by the 15th day of the 3rd month following the date its tax year ended", and the partnership must "prepare and give a Schedule K-1 to each person who was a partner in the partnership at any time during the year"  |
...
| A more-than-2% S corporation shareholder's health insurance belongs in W-2 wages | [S corporation compensation and medical insurance issues](https://www.irs.gov/businesses/small-businesses-self-employed/s-corporation-compensation-and-medical-insurance-issues), verbatim: "Health and accident insurance premiums paid on behalf of a greater than 2-percent S corporation shareholder-employee are deductible by the S corporation and reportable as wages on the shareholder-employee's Form W-2, subject to income tax withholding."  |
| Fixing it after the W-2 has gone out means reissuing forms | Follows from the above. Practice |
| Some tax letters run on a 30-day clock from the date at the top | [Topic no. 652, Notice of underreported income - CP2000](https://www.irs.gov/taxtopics/tc652), verbatim: "Respond within 30 days of the date of the notice or 60 days if you live outside the United States for a quick resolution." **The guide says "some of them", not "all"**, because the window differs by notice |
