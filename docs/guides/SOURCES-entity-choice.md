...
> **Read this before publishing. No primary page was opened.** `irs.gov`,
> `tax.ohio.gov`, `ecfr.gov` and `law.cornell.edu` are blocked by this
> container's network egress, and `ohiosos.gov` was tried and is blocked as
> well. Every citation below is the canonical URL for the rule, located through
> search, with the wording taken from search-returned extracts of that page.
> That is good enough to draft against and **not** good enough to publish a
> licensed firm's name over. Someone with an open browser should read each
> linked page against the claim beside it before this goes live.
>
> This page carries more of that risk than the two records guides do. Those
> describe what a document is and when it arrives. This one describes an
> election that is hard to reverse, so a wrong sentence here costs a reader more.
...
|---|---|
| An Ohio LLC is formed with the Ohio Secretary of State on Form 610 | [Form 610, Articles of Organization for a Domestic Limited Liability Company](https://www.ohiosos.gov/globalassets/business/forms/610.pdf); [Form 610 instructions](https://www.ohiosos.gov/globalassets/business/forms/610_instructions.pdf) |
| The filing names a statutory agent, at an Ohio address, who takes legal mail for the business | Same. The form appoints an agent "upon whom any process, notice or demand" may be served, and the agent must acknowledge and accept the appointment. Ohio uses *statutory agent*, not *registered agent* |
| The LLC exists when the articles are filed | [Ohio Revised Code 1706.16(D)](https://codes.ohio.gov/ohio-revised-code/section-1706.16), quoted in the Form 610 instructions |
...
| Claim in the draft | Source |
|---|---|
| A one-member LLC is not treated as separate from its owner unless it elects otherwise | [Single member limited liability companies](https://www.irs.gov/businesses/small-businesses-self-employed/single-member-limited-liability-companies); [LLC filing as a corporation or partnership](https://www.irs.gov/businesses/small-businesses-self-employed/llc-filing-as-a-corporation-or-partnership) — disregarded as an entity separate from its owner unless Form 8832 is filed |
| A two-or-more-member LLC is a partnership unless it elects otherwise | [LLC filing as a corporation or partnership](https://www.irs.gov/businesses/small-businesses-self-employed/llc-filing-as-a-corporation-or-partnership) — classified as a partnership unless Form 8832 is filed |
...
| The deadline is two months and fifteen days into the tax year the election is to start from | [Instructions for Form 2553](https://www.irs.gov/instructions/i2553) — no later than 2 months and 15 days after the beginning of the tax year the election is to take effect; it may also be filed in the preceding year |
| An LLC filing Form 2553 does not need a second form to be treated as a corporation | [Instructions for Form 2553](https://www.irs.gov/instructions/i2553), resting on Treas. Reg. 301.7701-3(c)(1)(v)(C) — an eligible entity that timely files Form 2553 is treated as having elected corporate classification and need not file Form 8832 |
| No more than 100 owners | [S corporations](https://www.irs.gov/businesses/small-businesses-self-employed/s-corporations); IRC 1361(b)(1) |
| Owners must be individuals, certain trusts or estates — not another company, and not someone living abroad | Same. Partnerships, corporations and nonresident aliens are not eligible shareholders |
...
| A late business return is charged a penalty per owner, per month, whether or not tax was owed | [Instructions for Form 1120-S](https://www.irs.gov/instructions/i1120s) — late filing of return, resting on IRC 6699. **The figure is deliberately absent**: it is adjusted for inflation each year, so naming it dates the page within twelve months |
...
| Nothing on this page sets one | **A statement about the page, and it is the point of the section.** `assumed.officer_compensation` in `client-documents/registry/fee-schedule.yaml` puts setting or reviewing the figure outside the flat engagement |
...
| That deduction is still there to be reduced | The deduction was scheduled to expire after 2025 and was made permanent by the act signed 4 July 2025. **Secondary sources only** — see the open list. The guide never names the deduction, a section, or a percentage, so it survives a change in the rate; it would not survive repeal |
...
| A fund, another company or an owner living abroad cannot hold the stock | [S corporations](https://www.irs.gov/businesses/small-businesses-self-employed/s-corporations); IRC 1361(b)(1) |
...
| Claim in the draft | Source |
|---|---|
| After the election ends, a new one generally cannot be made for five years without the IRS agreeing | [26 U.S.C. 1362(g)](https://uscode.house.gov/view.xhtml?req=granuleid%3AUSC-prelim-title26-section1362); Treas. Reg. 1.1362-5 — no new election for five taxable years unless the Commissioner consents |
