...
| A partnership files its own return and sends each owner a K-1 | [Partnerships](https://www.irs.gov/businesses/partnerships) — "A partnership must file an annual information return to report the income, deductions, gains, losses, etc., from its operations, but it does not pay income tax." Each partner then "reports their share of the partnership's income or loss on their personal tax return"  |
| The profit is taxed to the owners whether or not any of it was taken out | [Publication 541, Partnerships](https://www.irs.gov/publications/p541), verbatim: "Generally, a partnership doesn't pay tax on its income but passes through any profits or losses to its partners." The page adds that "Partners must include partnership items on their tax returns" — which is the *whether or not it was taken out* half, since inclusion does not depend on distribution |
| An owner working in the business pays self-employment tax on the profit, both halves of Social Security and Medicare | [Self-employment tax](https://www.irs.gov/businesses/small-businesses-self-employed/self-employment-tax-social-security-and-medicare-taxes), verbatim: "The self-employment tax rate is 15.3%. The rate consists of two parts: 12.4% for social security (old-age, survivors, and disability insurance) and 2.9% for Medicare (hospital insurance)." Both halves, in one sentence. The figures stay out of the guide |
...
| Claim in the draft | Source |
|---|---|
| The election is made on Form 2553 | [About Form 2553](https://www.irs.gov/forms-pubs/about-form-2553) — the form's own title is "Election by a Small Business Corporation", and the [instructions](https://www.irs.gov/instructions/i2553) tell an eligible entity to "Complete and file Form 2553" to make it |
...
| One class of stock | [S corporations](https://www.irs.gov/businesses/small-businesses-self-employed/s-corporations) — the eligibility list reads "Have only one class of stock"  |
...
| Claim in the draft | Source |
|---|---|
| The business files Form 1120-S and every owner gets a K-1 | [About Form 1120-S](https://www.irs.gov/forms-pubs/about-form-1120-s), verbatim: "Use Form 1120-S to report the income, gains, losses, deductions, credits, etc., of a domestic corporation or other entity for any tax year covered by an election to be an S corporation." The K-1 half is on the [instructions](https://www.irs.gov/instructions/i1120s): the corporation must "prepare and give a Schedule K-1 to each person who was a shareholder in the corporation at any time during the tax year"  |
| An owner who works in the business goes on the payroll and gets a W-2 | [S corporation compensation and medical insurance issues](https://www.irs.gov/businesses/small-businesses-self-employed/s-corporation-compensation-and-medical-insurance-issues), quoting the 1120-S instructions: "Distributions and other payments by an S corporation to a corporate officer must be treated as wages to the extent the amounts are reasonable compensation for services rendered to the corporation."  |
...
| Wages bring state and local obligations too (was: Ohio wants the wage side) | **Practice, after a cut on the firm's instruction (C063).** The bullet named Ohio and the city where the work happens. The firm's note: *ohio-specific stuff should maybe be shelved for now, focus federal then go beyond* Both citations were unreadable anyway — `tax.ohio.gov/business/employer-withholding` fetches 33,931 bytes of template markup with no body text. The guide now says only that wages bring state and local obligations, which is true everywhere and needs no Ohio page ** |
| Wages bring state and local obligations too (was: a city wants it too) | **FOLDED INTO THE SAME GENERIC SENTENCE (C064).** The firm rates RITA as more integral than the Ohio state side — *focus RITA before Ohio* — but was not certain of the claim itself: *i think this is likely true?* [RITA business services](https://www.ritaohio.com/Businesses) fetches 425 bytes of navigation and settles nothing. **An uncertain claim on an unreadable page does not belong on a client page**, so the specific municipal assertion is out until someone reads a RITA business page and writes down what it says. The RITA individual rule, by contrast, is verified and stays in the records guide ** |
| A late business return is charged a penalty per owner, per month, whether or not tax was owed | [Instructions for Form 1120-S](https://www.irs.gov/instructions/i1120s) — where no tax is due the penalty runs "for each month or part of a month (up to 12 months) the return is late", and is "multiplied by the total number of persons who were shareholders in the corporation during any part of the corporation's tax year for which the return is due". Per month, per owner, on a return with no tax owed. **The figure stays out of the guide**: it is inflation-adjusted annually |

## 05 · Reasonable compensation

| Claim in the draft | Source |
|---|---|
| An S corporation must pay a working owner a reasonable wage before paying that owner anything else | [S corporation compensation and medical insurance issues](https://www.irs.gov/businesses/small-businesses-self-employed/s-corporation-compensation-and-medical-insurance-issues), verbatim: "S corporations must pay reasonable compensation to a shareholder-employee in return for services that the employee provides to the corporation before non-wage distributions may be made to the shareholder-employee."  |
| Reasonable means what the same work would cost from someone else, in a business like yours | [S corporation compensation and medical insurance issues](https://www.irs.gov/businesses/small-businesses-self-employed/s-corporation-compensation-and-medical-insurance-issues) — the page lists "Some factors in determining reasonable compensation: Training and experience Duties and responsibilities Time and effort devoted to the business Dividend history Payments to non-shareholder employees Timing and manner of paying bonuses to key people What comparable businesses pay for similar services". The guide compresses that list to the factor a reader can actually apply |
| Set it too low and the IRS can treat what was taken out as wages and charge the payroll tax on it | [S corporation compensation and medical insurance issues](https://www.irs.gov/businesses/small-businesses-self-employed/s-corporation-compensation-and-medical-insurance-issues), quoting the 1120-S instructions: "Distributions and other payments by an S corporation to a corporate officer must be treated as wages to the extent the amounts are reasonable compensation for services rendered to the corporation." The page adds that "The IRS has the authority to reclassify payments made to shareholders from non-wage distributions"  |
...
| Claim in the draft | Source |
|---|---|
| Only the wage carries Social Security and Medicare tax; what is left after it does not | [S corporation compensation and medical insurance issues](https://www.irs.gov/businesses/small-businesses-self-employed/s-corporation-compensation-and-medical-insurance-issues) — the page turns on the difference between wages and "non-wage distributions (which are not subject to employment taxes)", which is the whole of the claim |
| A wage is not business profit, so the deduction that applies to business profit does not reach it | [Qualified business income deduction](https://www.irs.gov/newsroom/qualified-business-income-deduction), verbatim: "Income earned through a C corporation or by providing services as an employee is not eligible for the deduction." An S corporation owner's W-2 wage is exactly that second case |
| Moving profit into wages shrinks the business-profit deduction (was: that deduction is still there to be reduced) | **CUT (C073).** The firm asked *but what are we trying to say about it* — a fair question, because the row was tracking whether the deduction survives past 2025, which the guide never mentions and no primary page here settles. The point the guide actually needs is the mechanism, not the expiry: a deduction that applies to business profit does not apply to wages, so moving profit into wages shrinks it. That sentence is now written plainly and rests on the [QBI page](https://www.irs.gov/newsroom/qualified-business-income-deduction): "Income earned through a C corporation or by providing services as an employee is not eligible for the deduction." **No claim about permanence is made anywhere**  |
| Social Security tax stops at an amount of wages reset every year | [Self-employment tax](https://www.irs.gov/businesses/small-businesses-self-employed/self-employment-tax-social-security-and-medicare-taxes) — the page caps it ("For 2024, the first $168,600 of your combined wages, tips, and net earnings is subject to any combination of the social security part") and says the cap moves: "you must use the tax rate and maximum earnings limit in effect at the beginning of your tax year." **Note the page itself is showing a 2024 figure**, which is why the guide states the rule and no number |
