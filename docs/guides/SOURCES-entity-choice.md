...
| Ohio wants the wage side — a registration and returns | **UNVERIFIABLE FROM HERE, AND SAYING SO.** [Ohio employer withholding](https://tax.ohio.gov/business/employer-withholding) fetches 33,931 bytes that are almost entirely template markup and injector comments rather than readable content. Nothing usable was extracted |
| A city wants it too | **UNVERIFIABLE FROM HERE, AND SAYING SO.** [RITA business services](https://www.ritaohio.com/Businesses) fetches 425 bytes — a navigation strip listing "eFile Withholdings" and "Test and Upload W-2's" and nothing else. That a city wants withholding is consistent with it and is not stated by it |
...
| Rental profit carries no self-employment tax to start with | **PARTLY UNVERIFIABLE FROM HERE.** [Instructions for Schedule SE](https://www.irs.gov/instructions/i1040sse) is fetched and does carry a "Rental real estate business" heading, but the body under it did not extract. The exclusion is section 1402(a)(1); it is not quoted here because nothing here has read it in context. **The guide's sentence is the firm's own knowledge, not this citation's**  |
