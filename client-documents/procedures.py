...
def render() -> str:
    ...
    add("")
    add("Three things this deliberately does **not** know, and says so rather")
    add("than assuming:")
    add("")
    add("- **Form 8879.** It comes out of Drake and none of the twelve")
    add("  templates is one. The delivery letter's promise — *nothing is")
    add("  transmitted until the signed authorization is back* — is about that")
    add("  form, and this software has never seen one.")
    ...
    add("- **The records release.** It is addressed to the previous accountant")
    add("  and gates nothing here. Waiting on it would stop an engagement over")
