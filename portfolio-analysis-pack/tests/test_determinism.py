...
def test_a_different_run_date_changes_only_provenance_and_header_bands(effect_pack):
    ...
    for name, coord, va, vb in diffs:
        ...
        assert name in ("Cover", "1_Capture", "2_Prevalence", "3_Gradient", "4_Stratified", "5_Decomposition", "6_Model", "7_Control", "_provenance"), (name, coord)   # header bands carry the run date
