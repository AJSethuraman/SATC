...
Whitespace is normalised to one line per paragraph and nothing else is changed.
Every passage below was fetched on the date it carries, from the URL recorded
for its source in `SOURCES.md`.
