# Positions — the firm's own answers, binding and quoted exactly
...
## POS1 · The firm makes the de minimis safe harbour election, every year, on every return
...
where the answer is no, permanently. Without it, every small purchase is
capitalisable on its own facts.

The firm, on Q4, 5 September 2026: *"see I would just take the default threshold
here call it good generally so this is just a good question to have and to ratify
on the spot if you can and like I know that why it matters already has it but you
know asking it and not having that in your back pocket already umm I don't know I
guess maybe it is kind of a firm decision to say we're just going to follow that
for sure but it's a good question and it has the answer in it"*

And on Q19, the same instinct stated as a general rule: *"this is another safe
harbor moment for me like you don't have to defer to safe harbor but if there's
no reason not to I feel like you might as well in general"*

**What this desk cannot do about it.** The election is a filing act on the
return. This desk can say it is required and say when; it cannot see whether the
statement was attached. Whatever checks that lives in the return-preparation
...
September 2026: *"see I would just take the default threshold here call it good
generally"* — and, on Q18: *"having an answer to something like the first
question could immediately make all other questions basically not matter because
we're under a safe harbor that we just accept"*.

**Read the citation, and read what it is not.** This rests on an IRS web page,
which is SECONDARY — the Service explaining itself, not authority a client may
rely on. The regulation's own text at § 1.263(a)-1(f)(1)(ii)(D) still says $500
and defers the current figure to "published guidance in the Federal Register or
in the Internal Revenue Bulletin". That guidance is **Notice 2015-82**, which the
page cites and links and which **was not fetched by this session** — so the desk
holds the IRS's description of the notice and not the notice. Before ratifying,
somebody should read Notice 2015-82 itself and either add it as a primary source
or record here that the description is what the position rests on.

**And $2,500 is a ceiling, not the number.** § 1.263(a)-1(f)(1)(ii)(B) requires
the client to have a book policy at the beginning of the year; the safe harbour
...
## POS3 · The client's book expensing policy is set before the year opens, not at close

**Citation:** 26 CFR 1.263(a)-1(f)(1)(ii)(B) · **Recorded:** 2026-09-05
...
and is therefore the part that has to be built into the intake.

The firm, on Q18, 5 September 2026: *"so it's important for the context of the
business I guess to be known and I don't mean like whether they're a contractor
or something so much as like well do we have this set maybe that's something that
should be built into the software if that's not something we explicitly said
already so I guess like the agent could even come back with suggestions in that
case"*

**One correction the firm should see before ratifying.** For a client with no
applicable financial statement the procedure does **not** have to be in writing.
The IRS says so under "If you don't have an AFS, are you required to have a
written accounting procedure at the beginning of your taxable year?": *"you are
not required to have written accounting procedures; however, you must expense
amounts on your books and records for the taxable year in accordance with a
consistent accounting procedure or policy existing at the beginning of the
...
## POS4 · What the bank has not processed yet is a reconciling item
...
## POS5 · What was never recorded, or recorded wrong, is an entry
...
## POS6 · How many food-and-drink accounts the chart has to carry
...
## POS7 · A brewery or taproom charge is neither automatically entertainment nor automatically a meal
...
## POS10 · The vendor is evidence about what was bought. It is not the test
...
## POS12 · A cleaning service is a household cost until part of the home is shown to be the place of business
...
## POS13 · A card reward earned by spending reduces what was paid; it is not income
...
rebates however I would definitely like something to tell us for sure."*

**What the research found, including where it does not match.** The belief holds
for a reward earned by spending, and the reasoning is exactly the one the firm
named. It is stated in the IRS's own words at the citation above: *"A rebate
received by a buyer from the party to whom the buyer directly or indirectly paid
the purchase price for an item is an adjustment in purchase price, not an
accession to wealth, and is not includible in the buyer's gross income."* Rev.
Rul. 2005-28 restates the same rule from Rev. Rul. 76-96 and leaves that half of
it standing. Publication 525 says a cash rebate "isn't income" and reduces basis.

Three things do not match, and they are why this is a position rather than a
citation:

1. **"You get to just take those rebates" is the half that is wrong.** No source
   reached treats a rebate as a free-standing amount. Every one of them makes it
   a reduction of the price paid — basis in Publication 525, the cost recorded in
   inventory in Publication 334. Booking it to a Credit Card Rewards income
   account, which is what the close actually did, overstates income by the whole
   of it. What this position says instead is that it lands against the cost it
   came from.
2. **There is nothing "for sure" to hand over.** No statute and no regulation says
   it. The only IRS document that applies the rule to a CREDIT CARD is the letter
   ruling cited here, and its own last page says *"Section 6110(k)(3) of the Code
   provides that it may not be used or cited as precedent."* That is the answer to
   the firm's request, and it is not the answer they were hoping for.
3. **A reward not earned by spending is outside every source found.** The rule
   turns on a rebate received "from the party to whom the buyer directly or
   indirectly paid the purchase price". A sign-up bonus for opening an account, a
   referral bonus, or a reward for a transaction that is not a purchase does not
...
## POS14 · Nothing goes on a Form 1099-NEC for a payment the app already reports
...
like a safe harbor thing."* And, on the same instinct three questions earlier:
*"this is another safe harbor moment for me like you don't have to defer to safe
harbor but if there's no reason not to I feel like you might as well in general."*

**The "who cares" answer exists and it is in the regulation cited here.** A
payment made by payment card or through a third party payment network is reported
under section 6050W by the settlement entity "and not section 6041" — and the
regulation adds that the settlement entity's own de minimis threshold "is
disregarded in determining whether the transaction is subject to reporting under
section 6050W". So the payer is off the hook whether or not the app ever issues a
Form 1099-K. That is a real safe harbour and it is the firm's instinct exactly.

**Where it stops, and this is the part that needs the firm's judgement.** The
relief covers a *third party network transaction*, which § 1.6050W-1(c)(3)
defines as settlement under an arrangement where a substantial number of
PROVIDERS OF GOODS OR SERVICES hold accounts and have agreed to settle for
providing them. A peer-to-peer transfer sent as a personal payment is not
obviously settled under such an arrangement, and no source reached says what a
payer should do when it cannot tell which kind of transfer it made. This position
takes the conservative reading: where the payment was for services and there is
no evidence it went through the goods-and-services rail, count it toward the
$2,000 and report it. Reporting a payment that did not need reporting costs a
form; missing one costs a penalty.

**The threshold in this position is $2,000 and NOT $600, and the regulation this
position cites still says $600.** 26 U.S.C. § 6041(a) was amended to $2,000 by
...
obviously we shouldn't be like is it one or four we should be like OK how many
accounts should it be what other reasons could there be for that like I'm
assuming we want to know the reasoning so I had to give us the reasoning as well
no idea why I spelled tires with AY"*

So the deliverable is the reasoning, and the authority supplies it. Pub. 463
(2025) lists what the actual-expense method comprises at the citation above:
depreciation, lease payments, registration fees, licenses, insurance, repairs,
gas, garage rent, tires, oil, tolls and parking fees. Under "Choosing the
standard mileage rate" it also says the choice may swing year to year — a car the
taxpayer owns may go from the standard mileage rate to actual expenses in a later
year — and under "Standard Mileage Rate" that in a standard-mileage year none of
those components is separately deductible. A single blended Auto and Fuel account
cannot be split back into those lines after the fact, and it is the later year's
election that needs them.

**What this position does NOT settle, and why it is a position at all:** the
number. Pub. 463 says what the components are; it does not say how many general
ledger accounts a firm keeps for them, and nothing in the primary authority does
either. Three other reasons for splitting were raised by the same close and are
outside anything fetched here — a vehicle owned personally (POS2), interest on a
...
**Why:** The firm, 5 September 2026, went much wider than the question they were
asked: *"This is reasonable and I suppose maybe I didn't really even think about
this like this is kind of why earlier I said hmm what happens when there's
interest and stuff it needs to be separated technically is it a lease do they own
it does is it actually in the business's name is the entity an LLC that owns it
is the owner just using it and using it as an LLC which is like probably most
likely and that's what [a client] does do but like I'm trying to provide more
context so you can understand what all advice could be given and like this could
provoke questions back from the principle that's doing the work so this
influences even like what documents we might want whether we record it as an
asset whether it's depreciable et cetera and those are all things that we
probably charge for in a sense"*

The case they call most likely — the owner holds the vehicle personally and uses
it for an LLC — is the one the authority actually addresses, and it is not the
case where the business owns a truck. § 1.280F-6(d)(2)(i) makes qualified
business use "any use in a trade or business of the taxpayer", and the taxpayer
whose trade or business it is decides which return the vehicle sits on. Where the
driver is the owner or a relative, (d)(2)(ii)(A) takes that use OUT of qualified
business use unless it is reported as income with withholding; where the vehicle
belongs to someone else and the business merely pays for it, § 1.62-2 decides
whether those payments are a reimbursement or wages.

**Why this is a position and not an answer.** The authority says what follows from
each shape. It does not tell a preparer which shape they are in, and nothing in a
...
something telling us to get like loan statements and stuff to make sure we
understand the deal"* — and, on the same day, that whose vehicle it is *"influences
even like what documents we might want whether we record it as an asset whether
it's depreciable et cetera"*.

The authority supports each item on the list, and the list is what the firm asked
for:

- **Title or registration** — § 1.280F-6(d)(2)(i) turns on whose trade or business
  the use is in; nothing else on the file says whose name the vehicle is in.
- **Loan agreement and statements** — Pub. 463 (2025) under "Interest" separates
  the interest on a car loan, which survives even under the standard mileage rate,
  from the principal, which does not; the two are one debit in a bank feed.
- **Lease agreement** — Pub. 463 (2025) under "Deductible payments" and "Inclusion
  Amounts" makes a lease a different computation from ownership entirely, and
  under "Choosing the standard mileage rate" makes the election on a leased car
  binding "for the entire lease period".
- **Mileage log** — § 1.274-5T(c)(2)(i) requires "an account book, diary, log,
  statement of expense, trip sheets, or similar record", and (b)(6) makes the
  business-use amount an element that must be proved.
- **Insurance declarations page** — this one rests on nothing fetched here. It is
...
## POS19 · A business-use percentage is a figure obtained, never one assumed
...
The authority leaves no room in the method: § 1.280F-6(e)(2) says the use of a
passenger automobile is allocated "on the basis of mileage", business miles over
total miles, and § 1.274-5T(b)(6)(i)(B) makes both figures elements that must be
substantiated. § 1.274-5T(c)(3)(ii)(A) allows part of a year to stand for the
whole, but only where the taxpayer "can demonstrate by other evidence that the
periods for which an adequate record is maintained are representative" — and
VE12 in the problem set is the regulation's own case of a sample that is not.

What is left to the firm is what a close does when the log does not exist: book at
100% and flag it, leave the vehicle lines unclassified, or refuse the close. The
...
does is it actually in the business's name is the entity an LLC that owns it is
the owner just using it and using it as an LLC which is like probably most
likely"* — and the file records that question as connected to *"loan statements
and stuff to make sure we understand the deal"*.

The authority says what the answer depends on and refuses to guess it.
§ 1.62-2(c)(1) makes a reimbursement arrangement one that meets business
connection, substantiation and the return of excess — three things a bank feed
records none of. Direct expensing of fuel on the business card asserts an answer
to an ownership question nobody asked, and it is the one treatment that is
certainly wrong in the case the firm calls most likely.
