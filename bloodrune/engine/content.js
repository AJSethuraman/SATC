...
export const SKILLS = {
  ...
  fire_bolt: { id: 'fire_bolt', name: 'Fire Bolt', tab: 'fire', element: 'fire', role: 'filler', geo: 'seeker', glyph: '🔥', type: 'attack', target: 'single', reach: 1, cost: 2, scale: 'damage', weapon: 'spell', dmg: [4, 7], grow: 2, req: 1, pre: [], syn: { fire_ball: 0.04, meteor: 0.04 }, blurb: 'A bolt of fire that seeks the nearest foe' },
  ...
  inferno: { id: 'inferno', name: 'Inferno', tab: 'fire', element: 'fire', role: 'synergy', geo: 'cone', type: 'attack', target: 'aoe', reach: 1, cost: 3, manaPerSec: 12, scale: 'nova', weapon: 'spell', dmg: [1, 2], grow: 1, coneRange: 190, coneArc: 0.66, maxTargets: 6, req: 3, pre: ['fire_bolt'], syn: { fire_bolt: 0.05, fire_ball: 0.04 }, blurb: 'A CHANNELED cone of flame toward the nearest foe — burns what is in front continuously, but DRAINS mana fast (gear cost-reduction is what makes it sustainable; damage shown per tick)' },
  fire_ball: { id: 'fire_ball', name: 'Fire Ball', tab: 'fire', element: 'fire', role: 'nuke', geo: 'ball', glyph: '☄️', type: 'attack', target: 'aoe', reach: 1, cost: 6, scale: 'damage', weapon: 'spell', dmg: [9, 14], grow: 3, splashR: 96, maxTargets: 8, req: 5, pre: ['fire_bolt'], cd: 0.85, syn: { fire_bolt: 0.06, meteor: 0.05, inferno: 0.04 }, blurb: 'A hurled ball of fire that BURSTS on impact, splashing all foes nearby' },
  ...
  meteor: { id: 'meteor', name: 'Meteor', tab: 'fire', element: 'fire', role: 'nuke', geo: 'ground', type: 'attack', target: 'aoe', reach: 1, cost: 11, scale: 'nova', weapon: 'spell', dmg: [14, 22], grow: 3, radius: 150, maxTargets: 8, req: 9, pre: ['fire_ball'], cd: 1.6, syn: { fire_bolt: 0.05, fire_ball: 0.05, inferno: 0.04 }, blurb: 'Call a meteor down onto the pack — a heavy delayed blast' },
  // Cold
  ice_bolt: { id: 'ice_bolt', name: 'Ice Bolt', tab: 'cold', element: 'cold', role: 'filler', geo: 'seeker', glyph: '❄️', type: 'attack', target: 'single', reach: 1, cost: 2, scale: 'damage', weapon: 'spell', dmg: [3, 6], grow: 2, req: 1, pre: [], syn: { glacial_spike: 0.04, ice_blast: 0.04 }, blurb: 'A shard of ice that seeks a foe and chills it' },
  ...
  frost_nova: { id: 'frost_nova', name: 'Frost Nova', tab: 'cold', element: 'cold', role: 'synergy', geo: 'nova', type: 'attack', target: 'aoe', reach: 1, cost: 3, scale: 'nova', weapon: 'spell', dmg: [2, 5], grow: 1, radius: 130, maxTargets: 8, req: 3, pre: ['ice_bolt'], syn: { ice_bolt: 0.05, glacial_spike: 0.04 }, blurb: 'A ring of frost erupting from you — hits everything around' },
  ice_blast: { id: 'ice_blast', name: 'Ice Blast', tab: 'cold', element: 'cold', role: 'synergy', geo: 'seeker', glyph: '🧊', type: 'attack', target: 'single', reach: 1, cost: 6, scale: 'damage', weapon: 'spell', dmg: [7, 11], grow: 3, req: 5, pre: ['ice_bolt'], cd: 0.85, syn: { ice_bolt: 0.06, glacial_spike: 0.05 }, blurb: 'A blast of ice that freezes a single foe solid' },
  ...
  glacial_spike: { id: 'glacial_spike', name: 'Glacial Spike', tab: 'cold', element: 'cold', role: 'nuke', geo: 'ball', glyph: '🔷', type: 'attack', target: 'aoe', reach: 1, cost: 9, scale: 'nova', weapon: 'spell', dmg: [10, 16], grow: 3, splashR: 92, maxTargets: 8, req: 8, pre: ['ice_blast'], cd: 1.3, syn: { ice_bolt: 0.06, ice_blast: 0.05, frost_nova: 0.04 }, blurb: 'A spike of ice that BURSTS on impact, freezing the cluster' },
  // Lightning
  charged_bolt: { id: 'charged_bolt', name: 'Charged Bolt', tab: 'light', element: 'lightning', role: 'filler', geo: 'spread', type: 'attack', target: 'aoe', reach: 1, cost: 2, scale: 'damage', weapon: 'spell', dmg: [2, 4], grow: 1, boltBase: 3, boltMax: 9, spreadArc: 0.9, maxTargets: 4, req: 1, pre: [], syn: { nova: 0.04, chain_lightning: 0.04 }, blurb: 'A spray of erratic bolts that fan out and scatter — they do NOT seek (more bolts per level)' },
  thunder_storm: { id: 'thunder_storm', name: 'Thunder Storm', tab: 'light', element: 'lightning', role: 'synergy', geo: 'storm', type: 'attack', target: 'aoe', reach: 1, cost: 4, scale: 'nova', weapon: 'spell', dmg: [6, 12], grow: 2, stormRange: 380, strikeBase: 2, maxTargets: 6, req: 3, pre: [], syn: { charged_bolt: 0.04, nova: 0.04 }, blurb: 'The storm itself strikes — lightning falls from the sky onto scattered foes around you (more bolts per level)' },
  nova: { id: 'nova', name: 'Nova', tab: 'light', element: 'lightning', role: 'nuke', geo: 'nova', type: 'attack', target: 'aoe', reach: 1, cost: 6, scale: 'nova', weapon: 'spell', dmg: [5, 9], grow: 2, radius: 150, maxTargets: 12, req: 5, pre: ['charged_bolt'], cd: 1.0, syn: { charged_bolt: 0.06, chain_lightning: 0.05, lightning: 0.04 }, blurb: 'A shockwave of lightning expanding in every direction' },
  lightning: { id: 'lightning', name: 'Lightning', tab: 'light', element: 'lightning', role: 'nuke', geo: 'beam', type: 'attack', target: 'single', reach: 1, cost: 6, scale: 'damage', weapon: 'spell', dmg: [1, 34], grow: 5, beamLen: 540, beamW: 34, req: 6, pre: ['charged_bolt'], cd: 0.85, syn: { charged_bolt: 0.05, nova: 0.04 }, blurb: 'A bolt of raw lightning in a dead-straight line — HUGE damage, aim it down a lane' },
  light_mastery: { id: 'light_mastery', name: 'Lightning Mastery', tab: 'light', element: 'lightning', role: 'mastery', type: 'passive', scale: 'passive', kind: 'mastery', masteryPct: 0.08, cost: 0, req: 6, pre: ['thunder_storm'] },
  chain_lightning: { id: 'chain_lightning', name: 'Chain Lightning', tab: 'light', element: 'lightning', role: 'nuke', geo: 'arc', type: 'attack', target: 'aoe', reach: 1, cost: 9, scale: 'nova', weapon: 'spell', dmg: [6, 12], grow: 2, jumpBase: 3, jumpMax: 8, jumpRange: 215, maxTargets: 8, req: 8, pre: ['lightning'], cd: 1.3, syn: { charged_bolt: 0.05, nova: 0.05, lightning: 0.04 }, blurb: 'Lightning that auto-seeks and leaps foe to foe — good damage, jumps grow with skill' },
};
...
export const CLASSES = {
  ...
  sorceress: { id: 'sorceress', name: 'Sorceress', glyph: '🔮', maxLife: 52, maxMana: 34, manaRegen: 3, startBlock: 0, acc: 6, eva: 2,
    ...
    tree: ['fire_bolt', 'warmth', 'inferno', 'fire_ball', 'fire_mastery', 'meteor',
      ...
      'charged_bolt', 'thunder_storm', 'nova', 'lightning', 'light_mastery', 'chain_lightning'] },
};
