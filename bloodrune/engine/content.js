...
export const SKILLS = {
  ...
  inferno: { id: 'inferno', name: 'Inferno', tab: 'fire', element: 'fire', role: 'synergy', geo: 'cone', type: 'attack', target: 'aoe', reach: 1, cost: 3, scale: 'nova', weapon: 'spell', dmg: [3, 6], grow: 1, coneRange: 168, coneArc: 0.62, maxTargets: 8, req: 3, pre: ['fire_bolt'], syn: { fire_bolt: 0.05, fire_ball: 0.04 }, blurb: 'A cone of roaring flame — everything in front of you burns' },
  ...
  static_field: { id: 'static_field', name: 'Static Field', tab: 'light', element: 'lightning', role: 'utility', geo: 'nova', type: 'attack', target: 'aoe', reach: 1, cost: 3, scale: 'nova', weapon: 'spell', dmg: [3, 6], grow: 1, radius: 150, maxTargets: 10, req: 3, pre: [], blurb: 'Crackling static that jolts everything near you' },
