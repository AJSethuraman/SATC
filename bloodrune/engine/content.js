...
export const SKILLS = {
  ...
  inferno: { id: 'inferno', name: 'Inferno', tab: 'fire', element: 'fire', role: 'synergy', geo: 'cone', type: 'attack', target: 'aoe', reach: 1, cost: 2, manaPerSec: 8, scale: 'nova', weapon: 'spell', dmg: [1, 3], grow: 1, coneRange: 195, coneArc: 0.72, maxTargets: 10, req: 3, pre: ['fire_bolt'], syn: { fire_bolt: 0.05, fire_ball: 0.04 }, blurb: 'A CHANNELED cone of flame toward the nearest foe — stays lit and burns everything in front continuously, draining mana each second (damage shown per tick)' },
