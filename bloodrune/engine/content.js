...
export const SKILLS = {
  ...
  inferno: { id: 'inferno', name: 'Inferno', tab: 'fire', element: 'fire', role: 'synergy', geo: 'cone', type: 'attack', target: 'aoe', reach: 1, cost: 3, scale: 'nova', weapon: 'spell', dmg: [4, 8], grow: 2, coneRange: 195, coneArc: 0.72, maxTargets: 10, req: 3, pre: ['fire_bolt'], syn: { fire_bolt: 0.05, fire_ball: 0.04 }, blurb: 'A cone of roaring flame poured toward the nearest foe — you turn to face the swarm' },
