...
export const SKILLS = {
  ...
  fire_ball: { id: 'fire_ball', name: 'Fire Ball', tab: 'fire', element: 'fire', role: 'nuke', geo: 'projectile', type: 'attack', target: 'aoe', reach: 1, cost: 6, scale: 'damage', weapon: 'spell', dmg: [9, 14], grow: 3, maxTargets: 3, req: 5, pre: ['fire_bolt'], cd: 0.85, syn: { fire_bolt: 0.06, meteor: 0.05, inferno: 0.04 } },
  ...
  meteor: { id: 'meteor', name: 'Meteor', tab: 'fire', element: 'fire', role: 'nuke', geo: 'ground', type: 'attack', target: 'aoe', reach: 1, cost: 11, scale: 'nova', weapon: 'spell', dmg: [14, 22], grow: 3, radius: 150, maxTargets: 8, req: 9, pre: ['fire_ball'], cd: 1.6, syn: { fire_bolt: 0.05, fire_ball: 0.05, inferno: 0.04 }, text: 'Call down a meteor — heavy blast.' },
  // Cold
  ...
  ice_blast: { id: 'ice_blast', name: 'Ice Blast', tab: 'cold', element: 'cold', role: 'synergy', geo: 'projectile', type: 'attack', target: 'single', reach: 1, cost: 6, scale: 'damage', weapon: 'spell', dmg: [7, 11], grow: 3, req: 5, pre: ['ice_bolt'], cd: 0.85, syn: { ice_bolt: 0.06, glacial_spike: 0.05 } },
  ...
  glacial_spike: { id: 'glacial_spike', name: 'Glacial Spike', tab: 'cold', element: 'cold', role: 'nuke', geo: 'ground', type: 'attack', target: 'aoe', reach: 1, cost: 9, scale: 'nova', weapon: 'spell', dmg: [10, 16], grow: 3, radius: 140, maxTargets: 6, req: 8, pre: ['ice_blast'], cd: 1.3, syn: { ice_bolt: 0.06, ice_blast: 0.05, frost_nova: 0.04 }, text: 'A burst of ice shards.' },
  // Lightning
  ...
  lightning: { id: 'lightning', name: 'Lightning', tab: 'light', element: 'lightning', role: 'nuke', geo: 'line', type: 'attack', target: 'single', reach: 1, cost: 6, scale: 'damage', weapon: 'spell', dmg: [4, 16], grow: 3, req: 6, pre: ['charged_bolt'], cd: 0.85, syn: { charged_bolt: 0.05, nova: 0.04 } },
