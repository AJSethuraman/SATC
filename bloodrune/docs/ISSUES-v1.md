...
- [x] **S1 — Synergy engine + Sorceress trees (M1, headline).** Rewrite
...
- [x] **S2 — Elements + resistances + mastery-% + penetration + immunities (M2).**
...
- [x] **S3 — Loot rarity + itemTier gating + build-fit affixes (M3a).** 4 rarities;
...
- [x] **S5 — Attributes + equip requirements (M4).** Str/Dex/Vit/Energy; ~5
...
- [x] **S6 — Town loop + stash + starting loadout + respec + at-risk banking (M5).**
...
- [x] **S4 — Kill auto-equip + town equip/compare/salvage (M3b).** No auto-equip;
  ...
  *Blocked by: S3, S6.*
- [x] **S7 — Sockets/runes/runewords + enabler uniques (M6).** Bases roll sockets;
...
- [x] **S8 — Moment-to-moment + balance tuning + artifact smoke (M7).**
...
- [x] **S9 — Update DESIGN.md + PLAN.md** with the redesign + roadmap (Acts 2–5,
