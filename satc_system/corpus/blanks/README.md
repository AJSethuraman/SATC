...
| K-1 (1120-S) | `f1120ssk1.pdf` | https://www.irs.gov/forms-pubs/about-schedule-k-1-form-1120-s |
...
Save each as `f1099b.pdf` and `f1120ssk1.pdf` so the corpus finds them under the
names it expects.
